...
export default function PipelineKanban() {
  ...
  // Aggregate Metrics for Compact Summary
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans p-6 space-y-3">
      ...
      {/* ─── 3. COMPACT HORIZONAL STAGE FILTER BAR ──────────────────────────── */}
      ...
      {/* ─── 5. FULL-WIDTH ENTERPRISE CRM TABLE ───────────────────────────────── */}
                ...
                paginatedLeads.map((lead: any) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Stage Column (Editable Dropdown) */}
                      <td className="p-3.5">
                        <EditableStageBadge
                          lead={lead}
