...
const startServer = async () => {
  try {
    ...
    await sequelize.query('ALTER TABLE "Users" ADD COLUMN IF NOT EXISTS "teamType" VARCHAR(255);').catch(() => {});
    await sequelize.query('ALTER TABLE Users ADD COLUMN teamType TEXT;').catch(() => {});
